const testString = () => {
    ...
    ensure(equals(toTokens(s7), ['gua\nxiao', ',', 123, ';']), 'test string element 7')
...
const testVariable = () => {
    ...
    ensure(equals(toTokens(s2), ['const', 'b', '=', 222, ';']), 'test variable 2')
    ensure(equals(toTokens(s3), ['const', 'c', '=', '123', ';']), 'test variable 3')
}
...
const testGualangCode = () => {
    ...
    `
    let expect4 = ['if', '(', 1, '>', 2, ')', '{', ';', 'log', '(', '条件成立', ')', ';', '}', 'else', '{', ';', 'hello', '(', 1, ')', ';', '}', ';',]
    ...
    let expect5 = ['var', 'n2', '=', 1, ';', 'var', 'a', '=', 123, ';',
        'var', 'fun', '=', '14hh', ';',
        'if', '(', 'n2', '%', 2, '==', 0, ')', '{', ';',
        'log', '(', '偶数', ')', ';',
        '}', 'else', '{', ';',
    ...
    let expect8 = ['var', 'arr', '=', '[', 1, ',', 2, ',', 3, ',', 4, ',', 5, ',', 6, ',', ']', ';']
    ensure(equals(toTokens(s8), expect8), 'test variable 8')

    let s9 = `var a = m["a"]
        m["gua"] = "No.1"
        m["hello"] `
    let expect9 = ['var', 'a', '=', 'm', '[', 'a', ']', ';',
        'm', '[', 'gua', ']', '=', 'No.1', ';',
        'm', '[', 'hello', ']', ';']
    ...
    let expect10 = ['while', '(', 'conditionExpression', ')', '{', ';',
        'statement', ';',
        'continue', ';',
        'break', ';',
        '}', ';'
    ...
    let expect11 = ['funcName', '(', 'para1', '=', 'xxx', ',', 'para2', '=', 'yyy', ')', ';']
